...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'LAG.data';
    var REMOTE_PACKAGE_BASE = 'LAG.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_LAG.data');

    };
    Module['addRunDependency']('datafile_LAG.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 0, "filename": "/input.txt"}], "remote_package_size": 0, "package_uuid": "8d53cc08-c86f-49f2-ab3b-7867ea29f610"});
...
var real__generateFiles = asm["_generateFiles"];
asm["_generateFiles"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__generateFiles.apply(null, arguments);
};
...
var _generateFiles = Module["_generateFiles"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_generateFiles"].apply(null, arguments)
};
